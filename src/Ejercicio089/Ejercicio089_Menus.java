...
public class Ejercicio089_Menus {

    private static String idioma = "ES";

    public static void seleccionarIdioma() {
        Scanner sc = new Scanner(System.in);
        Ejercicio089_Utilidades.mostrarEncabezado("SELECCIÓN DE IDIOMA / LANGUAGE SELECTION");
    ...
    public static boolean menuInicioSalir() {
        Scanner sc = new Scanner(System.in);
        Ejercicio089_Utilidades.mostrarEncabezado(idioma.equals("ES") ? "MENÚ PRINCIPAL" : "MAIN MENU");
