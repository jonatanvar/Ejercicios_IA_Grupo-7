/**
 * Ejercicio002_Utilidades.java
 * Rol: Proporciona funciones de utilidad para formatear la salida con bordes
 * Unicode, centrar texto y mostrar los sellos personalizados (completo y corto)
 * para el ejercicio EJ-002.
 *
 * Sello personalizado - Versión corta
 * ┌────────────────────────────────────────────────────────────────────┐
 * │   Cristina Cruz | Lis❤ | cristinacruz@unah.hn | 002 | 2025-10-10  │
 * └────────────────────────────────────────────────────────────────────┘
 */
...
public class Ejercicio002_Utilidades {
    ...
    public static void mostrarEncabezadoCompleto(String codigoEjercicio, String fecha) {
        ...
        System.out.println(LINEA_SEP);
        System.out.println(BORDE_IZQ + "Análisis: Este programa muestra los sellos personalizados" + " ".repeat(ANCHO - 55 - 4) + BORDE_DER);
        System.out.println(BORDE_IZQ + "(completo y corto) en cuadros elegantes." + " ".repeat(ANCHO - 39 - 4) + BORDE_DER);
