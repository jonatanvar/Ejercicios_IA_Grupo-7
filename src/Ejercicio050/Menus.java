 ...
 * (ejecutar/finalizar) y el menú de selección de figuras.
 */
public class Menus {
    ...
    /**
     * Muestra y gestiona el menú de selección de figuras.
     * @param scanner El objeto Scanner para leer la entrada del usuario.
     * @param idioma La clave del idioma a utilizar para los textos.
     * @return La opción de figura seleccionada (1-5), 6 para regresar, o -1 si la entrada fue inválida.
     */
    public int menuFiguras(Scanner scanner, String idioma) {
        int opcion = -1;
        
        System.out.println("\n" + Utilidades.getTexto(idioma, "MENU_FIGURAS_TITULO"));
        System.out.println(Utilidades.getTexto(idioma, "FIGURA_CIRCULO"));
        System.out.println(Utilidades.getTexto(idioma, "FIGURA_CUADRADO"));
        System.out.println(Utilidades.getTexto(idioma, "FIGURA_TRIANGULO"));
        System.out.println(Utilidades.getTexto(idioma, "FIGURA_RECTANGULO"));
        System.out.println(Utilidades.getTexto(idioma, "FIGURA_ROMBO"));
        System.out.println(Utilidades.getTexto(idioma, "MENU_FIGURAS_OPCION_REGRESAR"));
        System.out.print(Utilidades.getTexto(idioma, "MENU_FIGURAS_PROMPT"));
        ...
        try {
            ...
            // Manejar error de entrada no numérica
            System.out.println(Utilidades.getTexto(idioma, "ERR_OPCION_INVALIDA_FIGURA"));
            scanner.nextLine(); // Limpiar buffer
            opcion = -1;
        }
        ...
        if (opcion < 1 || opcion > 6) {
            System.out.println(Utilidades.getTexto(idioma, "ERR_OPCION_INVALIDA_FIGURA"));
            return -1; // Opción fuera de rango
        }
        
        // Si la opción es 6, se regresa al menú de control y no se procesa la figura
        if (opcion == 6) {
             System.out.println(Utilidades.getTexto(idioma, "MSG_REGRESAR"));
        }
