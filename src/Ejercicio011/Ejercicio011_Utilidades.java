...
public class Ejercicio011_Utilidades {
    ...
    public static void mostrarSaludo() {
        ...
        System.out.println(BORDE_IZQ + centrarTexto("EJERCICIO 011: ENCONTRAR MAYOR Y MENOR", ANCHO - 2) + BORDE_DER);
    ...
    public static boolean mostrarIngresoNumero(Scanner scanner, int[] digitos) {
        ...
        System.out.println("├" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┤");
        System.out.println(BORDE_IZQ + centrarTexto("Ejemplo: 12345 o -12345", ANCHO - 2) + BORDE_DER);
    ...
    public static void mostrarResultado(int[] digitos, int mayor, int menor) {
        System.out.println("\n┌" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┐");
        System.out.println(BORDE_IZQ + centrarTexto("DÍGITOS INGRESADOS", ANCHO - 2) + BORDE_DER);
        System.out.println("├" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┤");
        String listaDigitos = "Dígitos: " + digitos[0] + ", " + digitos[1] + ", " + digitos[2] + ", " + digitos[3] + ", " + digitos[4];
        System.out.println(BORDE_IZQ + centrarTexto(listaDigitos, ANCHO - 2) + BORDE_DER);
        System.out.println("└" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┘");

        System.out.println("\n┌" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┐");
        System.out.println(BORDE_IZQ + centrarTexto("RESULTADOS", ANCHO - 2) + BORDE_DER);
        System.out.println("├" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┤");
        System.out.println(BORDE_IZQ + centrarTexto("Mayor dígito: " + mayor, ANCHO - 2) + BORDE_DER);
        System.out.println(BORDE_IZQ + centrarTexto("Menor dígito: " + menor, ANCHO - 2) + BORDE_DER);
        System.out.println("└" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┘");
    }
    ...
    public static void mostrarSelloCorto() {
        ...
        System.out.println(BORDE_IZQ + centrarTexto("Jonatan Varela | jivarelag@unah.hn | 011 | 2025-10-10", ANCHO - 2) + BORDE_DER);
        System.out.println("└" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┘");
    }
