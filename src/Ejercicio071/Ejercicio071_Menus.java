...
public class Ejercicio071_Menus {
    ...
    public static void seleccionarIdioma() {
        ...
        Ejercicio071_Utilidades.mostrarEncabezado("SELECCIÓN DE IDIOMA / LANGUAGE SELECTION");
    ...
    public static boolean menuInicioSalir() {
        ...
        Scanner sc = new Scanner(System.in);
        Ejercicio071_Utilidades.mostrarEncabezado(idioma.equals("ES") ? "MENÚ PRINCIPAL" : "MAIN MENU");
