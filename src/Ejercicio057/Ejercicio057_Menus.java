...
public class Ejercicio057_Menus {
    ...
    public static void seleccionarIdioma() {
        ...
        Ejercicio057_Utilidades.mostrarEncabezado("SELECCIÓN DE IDIOMA / LANGUAGE SELECTION");
    ...
    public static boolean menuInicioSalir() {
        ...
        Ejercicio057_Utilidades.mostrarEncabezado(idioma.equals("ES") ?
