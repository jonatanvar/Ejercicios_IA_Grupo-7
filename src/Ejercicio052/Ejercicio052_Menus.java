...
public class Ejercicio052_Menus {
    ...
    public static void seleccionarIdioma() {
        ...
        Ejercicio052_Utilidades.mostrarEncabezado("SELECCIÓN DE IDIOMA / LANGUAGE SELECTION");
    ...
    public static boolean menuInicioSalir() {
        ...
        Ejercicio052_Utilidades.mostrarEncabezado(idioma.equals("ES") ?
