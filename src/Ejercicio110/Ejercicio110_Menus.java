...
public class Ejercicio110_Menus {
    ...
    public static void seleccionarIdioma() {
        ...
        Ejercicio110_Utilidades.mostrarEncabezado("SELECCIÓN DE IDIOMA / LANGUAGE SELECTION");
    ...
    public static boolean menuInicioSalir() {
        ...
        Ejercicio110_Utilidades.mostrarEncabezado(idioma.equals("ES") ?
