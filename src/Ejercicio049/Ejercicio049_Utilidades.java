...
public class Ejercicio049_Utilidades {
    private static final Scanner scanner = new Scanner(System.in);
    private static final String LINEA = "---------------------------------------------------------------------";
    private static final int ANCHO = 70;

    /** Muestra sello personalizado actualizado */
    public static void mostrarSelloCorto() {
        ...
        String sello = "Cristina Cruz | Lis❤ | cristinacruz@unah.hn | 049 | 2025-11-04";
    ...
    public static void mostrarResultado(int idioma, String tipo, int original, String resultado) {
        String[] txt = textos(idioma);
        System.out.println("\n" + txt[8].replace("{tipo}", tipo.toUpperCase()));
