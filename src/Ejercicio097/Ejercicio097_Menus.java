...
public class Ejercicio097_Menus {
    ...
    public static void seleccionarIdioma() {
        ...
        Ejercicio097_Utilidades.mostrarEncabezado("SELECCIÓN DE IDIOMA / LANGUAGE SELECTION");
    ...
    public static boolean menuInicioSalir() {
        ...
        Ejercicio097_Utilidades.mostrarEncabezado(idioma.equals("ES") ?
