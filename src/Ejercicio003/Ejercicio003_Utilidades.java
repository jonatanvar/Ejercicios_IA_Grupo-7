...
public class Ejercicio003_Utilidades {
    ...
    public static void mostrarSaludo() {
        ...
        System.out.println(BORDE_IZQ + centrarTexto("EJERCICIO 003: ARITMÉTICA PRE-BÁSICA", ANCHO - 2) + BORDE_DER);
    ...
    public static void mostrarIngresoNumeros(Scanner scanner, double[] numeros) {
        System.out.println("\n┌" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┐");
        System.out.println(BORDE_IZQ + centrarTexto("INGRESO DE NÚMEROS", ANCHO - 2) + BORDE_DER);
        System.out.println("├" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┤");
    ...
    // Método mejorado: imprime el texto dentro del cuadro correctamente alineado
    ...
    public static void mostrarResultado(double suma, double resta) {
        resta = Math.abs(resta); // Asegura que la diferencia no sea negativa
        System.out.println("\n┌" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┐");
        System.out.println(BORDE_IZQ + centrarTexto("RESULTADOS DE LAS OPERACIONES", ANCHO - 2) + BORDE_DER);
        System.out.println("├" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┤");
        imprimirLineaConDato("Suma: " + suma);
        imprimirLineaConDato("Diferencia: " + resta);
        System.out.println("└" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┘");
    }
    ...
    public static void mostrarSelloCorto() {
        ...
        System.out.println(BORDE_IZQ + centrarTexto("Jonatan Varela | jivarelag@unah.hn | 003 | 2025-10-09", ANCHO - 2) + BORDE_DER);
        System.out.println("└" + String.valueOf(LINEA_H).repeat(ANCHO - 2) + "┘");
    }
