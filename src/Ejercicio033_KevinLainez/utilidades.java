...
public class utilidades {
    ...
    public static void mostrarSaludo() {
        ...
        System.out.println(centrarTexto("¡BIENVENIDO AL EJERCICIO #33!"));
        System.out.println(centrarTexto("GENERACIÓN DE PATRONES CON FOR ANIDADOS"));
        System.out.println(dibujarLineaHorizontal('└', '┘'));
        System.out.println();
    }

    public static void mostrarSelloCorto() {
        String sello = "Kevin Lainez | klainezs@unah.hn | 033 | 2025-11-03";
        System.out.println();
        System.out.println(dibujarLineaHorizontal('┌', '┐'));
    ...
    public static void mostrarEncabezadoPatrones() {
        System.out.println(dibujarLineaHorizontal('┌', '┐'));
        System.out.println(centrarTexto("** INICIO DE DIBUJO DE PATRONES **"));
        System.out.println(dibujarLineaHorizontal('├', '┤'));
    }

    public static void mostrarPiePatrones() {
        System.out.println(dibujarLineaHorizontal('└', '┘'));
    }
}