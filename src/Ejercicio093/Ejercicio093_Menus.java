...
public class Ejercicio093_Menus {
    ...
    public static void seleccionarIdioma() {
        ...
        Ejercicio093_Utilidades.mostrarEncabezado("SELECCIÓN DE IDIOMA / LANGUAGE SELECTION");
    ...
    public static boolean menuInicioSalir() {
        ...
        Ejercicio093_Utilidades.mostrarEncabezado(idioma.equals("ES") ?
